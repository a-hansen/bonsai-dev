...
The workspace contains requirements, architecture, roadmap, and current resume state; optional useful generated-map selections belong only in project `agent_context.md`.
