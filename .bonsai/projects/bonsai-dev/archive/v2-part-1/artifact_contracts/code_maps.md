...
| `MAP-V2-03` | `repo_session.md` supports conversation-only calibration | **External source without Bonsai project memory** | Adapt | Combine actual external source with optional calibration; project memory is not required. | External-source fixture creates a reusable named map without `../../../..`. |
