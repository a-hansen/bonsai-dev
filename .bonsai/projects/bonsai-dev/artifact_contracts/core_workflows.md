...
| `.bonsai/skills/phase_execution.md` | mode selection; plan lifecycle; boundary discipline; Pass A/B semantics; review gates; continuation; stop conditions | `CORE-PHASE-01`–`CORE-PHASE-08` | Closed |
| `.bonsai/skills/final_truth_update.md` | ownership boundary; impact classification; approval; reconciliation; invoking-gate return | `CORE-TRUTH-01`–`CORE-TRUTH-04` | Closed |
| `.bonsai/skills/dry_run.md` | optional trigger; read-only preview; approved basis; baseline lifecycle; revision stop | `CORE-DRY-01`–`CORE-DRY-04` | Closed |
| `.bonsai/skills/handoff.md` | completion reconciliation; state pruning; reporting; observations; gate return; session continuation | `CORE-HANDOFF-01`–`CORE-HANDOFF-06` | Closed |
