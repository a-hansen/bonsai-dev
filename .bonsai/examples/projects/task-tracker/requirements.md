...
**Problem Solved:** A user needs a simple local way to track personal tasks by creating them, reviewing them, marking them complete, editing them, and removing them. The example project also needs enough real behavior to demonstrate requirements, architecture, and phased execution without becoming oversized.  
...
* **System Constraints:** [Java 17 target version, Gradle Wrapper, JUnit 5, Standard single-module Gradle Java project, Command-line application, Executable JAR with manifest main class]
...
* **Accepted Decisions:** [The example is a Java 17 CLI application, The build uses the Gradle Wrapper, Tests use JUnit 5, The project uses a standard single-module Gradle Java layout, The build produces an executable JAR with a manifest main class]
