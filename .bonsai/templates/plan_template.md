...
1. **<Phase 1 Name>:** <Objective> | **Mode:** <Single-pass / Two-pass contract-first> |
   **Status:** <Pending / Active / Awaiting Review / Blocked / Complete> | 
   **Plan:** <`plan_phase_<N>.md` or `None`>
...
*(Use ONLY if the active phase does not have a separate `plan_phase_<N>.md` file. Otherwise
