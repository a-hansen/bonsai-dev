...
* **<Subsystem Name>:** <Purpose> | **Owns:** [Responsibilities] | **Not Owns:** [Boundaries] | *
...
* **<Concept>:** <Purpose> | **Owned by:** <Subsystem> | **Properties:** [List] | **Lifecycle:
  ** [Rules]
* **State & Persistence:
  ** [List data categories, where they live, persistence rules, and ownership boundaries]
...
* **Open Questions:** [Active architecture questions, max 5]