...
local map workspace memory remains separate and is not listed here. Optional human-owned `map_calibration.md` is
source-local guidance for the mapping workflow, not a generated related-map file.
